...
<head>
    ...
    <title>BANK BMH (Baitul Maal Hidayatullah) Makassar</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <a href="register.php" class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0 me-3">
                    <span class="d-flex align-items-center">
                        <!-- <i class="fa fa-user me-2"></i> -->
                        <span class="small">Buka Tabungan</span>
                    </span>
                </a>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <a href="register.php" class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0">
                            <span class="d-flex align-items-center">
                                <span class="small">Buka Tabungan</span>
                            </span>
                        </a>
